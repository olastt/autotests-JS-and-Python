...
4. 5 + 1 + "number" = 6 number //т.к. сначала сложение потом предобразование в строку
...
9. "five" + + "two" =fiveNaN /*операция + “two” - попытка преобразовать "two" в число, и получается NaN
а дальше "five" +NaN - преобразование в строку
и получается "five" + + "two" = fiveNaN*/
10. 'true' == true = false //тут true - boolean и конвертируется в 1, а строка true - не равно 1, поэтому false
